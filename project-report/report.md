...
POST operation. The function corresponding to this endpoint is defined in a file
called gatherData.py, and uses Flask.request() to read in a user's text
file. The text file is processed and the classification occurs. The results of
the classification are then returned and displayed as an HTML page using
...
return to the homepage via another JavaScript button, where they can upload
